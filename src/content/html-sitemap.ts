export const htmlSitemapGroups: { heading: string; links: { href: string; label: string }[] }[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { href: "/travel-agency-website-kerala", label: "Travel agency websites" },
      { href: "/real-estate-website-kerala", label: "Real estate websites" },
      { href: "/furniture-shop-website-kerala", label: "Furniture shop websites" },
      { href: "/car-showroom-website-kerala", label: "Car showroom websites" },
      { href: "/wedding-planner-website-kerala", label: "Wedding planner websites" },
      { href: "/professional-service-website-kerala", label: "Professional service websites" },
      { href: "/vehicle-service-website-kerala", label: "Vehicle service websites" },
      { href: "/jewellery-crm-kerala", label: "Jewellery CRM" },
      { href: "/construction-crm-kerala", label: "Construction CRM" },
      { href: "/clinic-management-software-kerala", label: "Clinic management software" },
