...
const businessResults = [
  ...
  "We generate enquiries through local SEO and paid ads when those services are scoped",
  "We engineer custom, scalable software & mobile applications for your exact operations",
  "We help Kerala businesses appear in Google Search and Maps with honest SEO work — not guaranteed #1 rankings",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="mt-10 flex flex-col sm:flex-row gap-4">
                ...
                <Link href="/contact" onClick={() => track("estimate_start", { location: "home" })} className="inline-flex items-center bg-transparent border-2 border-white hover:bg-white hover:text-gray-900 text-white font-bold py-4 px-8 rounded-full transition-all duration-300">
            ...
            <div className="bg-gradient-to-br from-indigo-50 to-blue-50 border border-blue-100 p-8 rounded-3xl relative">
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="bg-white p-5 rounded-2xl shadow-sm border border-gray-100">
                  ...
                  <div className="text-xs text-gray-500 uppercase font-semibold">25 Google Reviews</div>
                </div>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-10">
              ...
              <a
                ...
                onClick={() => track("whatsapp_click", { location: "home" })}
              ...
              <a
                ...
                onClick={() => track("phone_click", { location: "home" })}
            ...
            <p className="text-xs sm:text-sm text-gray-500">
              📍 Korani, Thiruvananthapuram district, Kerala · Serving Kerala · WhatsApp +91 94003 55185
            </p>
