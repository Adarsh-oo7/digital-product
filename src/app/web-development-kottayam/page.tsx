      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-20">
          <span className="inline-block bg-purple-100 text-purple-600 text-sm px-4 py-1 rounded-full mb-4 font-medium">
            Web Development — Kottayam, Kerala
          </span>
          <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6 leading-tight">
            Web Development in <span className="text-purple-600">Kottayam</span>
            <br />Digital Growth for Kottayam Businesses
          </h1>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            We provide professional <strong>web development services in Kottayam, Kerala</strong>. From SEO and web development to WhatsApp automation and AI chatbots — we help Kottayam businesses grow online. Based in Trivandrum, serving all of Kerala.
          </p>
          <div className="mt-8 flex justify-center gap-4 flex-wrap">
            ...
            <Link href="https://wa.me/919400355185?text=Hi%20Adarsh%2C%20I%20need%20help%20with%20Web%20Development%20in%20Kottayam" target="_blank" rel="noopener noreferrer" className="border border-gray-300 px-8 py-3 rounded-full font-semibold hover:bg-gray-100 transition">
              WhatsApp Now
            </Link>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-10 mb-20">
          <div className="bg-white p-10 rounded-3xl shadow-lg border border-gray-100">
            <h2 className="text-2xl font-bold mb-6 text-gray-800">Services We Offer in Kottayam</h2>
          ...
          <div className="bg-white p-10 rounded-3xl shadow-lg border border-gray-100">
            <h2 className="text-2xl font-bold mb-6 text-gray-800">Why Kottayam Businesses Choose Us</h2>
            <ul className="space-y-4 text-gray-600">
              {[
                "Kerala-based team that understands local markets",
                "Low competition in Kottayam — rank faster",
        ...
        <div className="mb-20 bg-purple-50 border border-purple-100 rounded-2xl p-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              <Link key={i} href={c.href} className="flex items-center gap-2 p-3 bg-white rounded-xl border border-gray-200 hover:border-purple-400 transition text-sm font-medium text-gray-700 hover:text-purple-600">
                <span>📍</span>{c.city}
              </Link>
            ))}
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              <Link key={i} href={item.href} className="flex items-center gap-3 p-4 bg-white rounded-xl border border-gray-200 hover:border-purple-400 transition group">
                ...
                <span className="font-medium text-gray-700 group-hover:text-purple-600">{item.title}</span>
              </Link>
            ))}
          </div>
        </div>
        ...
        <div className="relative bg-purple-600 text-white p-14 rounded-3xl text-center overflow-hidden">
          ...
          <p className="mb-8 text-purple-100 text-lg">
            📍 Serving Kottayam &amp; All of Kerala &middot; Reply within 2 hours
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="tel:+919400355185" className="inline-flex items-center justify-center px-8 py-4 font-semibold rounded-full bg-purple-500 text-white border border-white/30 hover:bg-purple-400 transition-all duration-300">
              📞 Call Now
            </Link>
          </div>
        </div>
