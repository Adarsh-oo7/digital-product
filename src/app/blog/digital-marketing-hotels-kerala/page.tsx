...
export const metadata = pageMetadata({
  title: "Best Digital Marketing Strategies for Hotels & Resorts in Kerala 2026",
  ...
  path: "/blog/digital-marketing-hotels-kerala",
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <Breadcrumbs
          items={[
            { name: "Home", href: "/" },
            { name: "Blog", href: "/blog" },
            { name: "Best Digital Marketing Strategies for Hotels & Resorts in Kerala 2026", href: "/blog/digital-marketing-hotels-kerala" },
          ]}
        />
