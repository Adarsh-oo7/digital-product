    ...
    <section className="min-h-screen mt-7 bg-gradient-to-b from-white to-gray-50 py-32 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-20">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">We build e-commerce websites for Kerala businesses — fashion, food, Ayurveda products, handicrafts, grocery and more. Payment gateway integration, inventory management and WhatsApp order notifications. Published package range: ₹35,000–₹70,000+.</p>
        ...
        <div className="mb-16 bg-orange-50 border border-orange-100 rounded-2xl p-8">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              { href: "/ecommerce-website-cost-kerala", icon: "₹", title: "E-commerce cost in Kerala", desc: "One-time, gateway and running costs" },
              { href: "/affordable-ecommerce-website-kerala", icon: "🛒", title: "Affordable online stores", desc: "What a smaller catalogue build includes" },
              { href: "/restaurant-website-online-ordering-kerala", icon: "🍽️", title: "Restaurant websites", desc: "Menus, WhatsApp orders, locations" },
              { href: "/contact", icon: "📞", title: "Get a project estimate", desc: "Talk to the Kerala team" },
            ].map((item, i) => (
        ...
        <div className="relative bg-orange-600 text-white p-14 rounded-3xl text-center overflow-hidden">
          <h2 className="text-4xl font-bold mb-4">Published range ₹35,000–₹70,000+</h2>
          <p className="mb-8 text-orange-100 text-lg">Based in Korani, Thiruvananthapuram district · Serving Kerala · Request an estimate for your catalogue size</p>
        ...
        <WorkStoriesBand
          slugs={["squeeze-berriez", "kerala-sellers"]}
          heading="Kerala product sites that are live"
        />
        <CtaBand whatsappText="Hi, I want an estimate for an online store" />
      </div>
    </section>
  );
}
