    ...
    <>
      ...
      <div className="min-h-screen py-16 px-4 mt-20">
        <div className="absolute inset-0 z-0 pointer-events-none">
          <div className="absolute w-[700px] h-[700px] bg-blue-300/30 rounded-full blur-3xl top-1/2 left-1/3 -translate-x-1/2 -translate-y-1/2" />
          <div className="absolute w-[700px] h-[700px] bg-purple-300/30 rounded-full blur-3xl top-1/2 left-2/3 -translate-x-1/2 -translate-y-1/2" />
        </div>
